...
ActiveRecord::Schema.define(:version => 20110808131425) do
  ...
  create_table "vimeo_embed_cache", :force => true do |t|
    t.string   "vid"
    t.string   "code"
  ...
  add_index "vimeo_embed_cache", ["vid"], :name => "index_vimeo_embed_cache_on_vid"

  create_table "vimeo_meta_cache", :force => true do |t|
    t.string   "vid"
    t.string   "title"
    t.text     "description"
    t.integer  "image_id"
  ...
  add_index "vimeo_meta_cache", ["vid"], :name => "index_vimeo_meta_cache_on_vid"
